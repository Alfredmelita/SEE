...
print(sum_result) # This to get the output of running the addition of the two numbers
print(difference_result) # This to get the output of running the division of the two numbers
print(product_result) # This to get the output of running the multiplication of the two numbers